...
app.get('/team_stats', function(req, res) {
  ...
  .then(game_info => {
    res.render('pages/team_stats', {
      my_title: "Team Stats",
      games: game_info[0],
      wins: game_info[1][0].count,
      losses: game_info[2][0].count
    })
  })
...
app.get('/player_info/post', function(req, res){
	...
	var specific = 'select * from football_players where id = ' + req.query.player_choice + ';'
	var num_games = 'SELECT COUNT(*) FROM football_games INNER JOIN football_players ON football_players.id = ANY(football_games.players::int[])' +
		'WHERE football_players.id = ' + req.query.player_choice + ';';
	db.task('get-everything', task => {
		return task.batch([
			task.any(players),
			task.any(specific),
